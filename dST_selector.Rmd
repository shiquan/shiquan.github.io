...
This vignette demonstrates how to use dST build functions to interactively select or pick cells/spots from a plot using your mouse and keyboard. While tools like CellxGene are widely used for this purpose, to the best of our knowledge, an efficient solution for performing this task within the R environment is still lacking.
...
## Select concave hull of selected region
...
If you have any questions regarding this vignette, the usage of dST or suggestions, please feel free to report them through the [discussion forum](https://github.com/shiquan/dST/discussions).
