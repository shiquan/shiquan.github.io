...
Now we have two weight matrices. If no name is specified, the first matrix will always be used by default, so we need to explicitly specify "pca_wm" to avoid misusing the weight matrix.
```{r}
