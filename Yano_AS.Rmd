...
Due to the generally low coverage of gene bodies and the presence of dropouts, it is difficult to capture enough skipped reads in scRNA-seq. As a result, the PSI method may not be well-suited for 3' or 5' biased scRNA-seq data in some cases.
